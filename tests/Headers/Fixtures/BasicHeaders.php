...
final readonly class BasicHeaders implements SchemaInterface
{
    ...
    {
        return AuthorizationScheme::tryFrom($data['authorization'])?->equals(AuthorizationScheme::BASIC)
            ?? false;
    }
    ...
    {
        $credentials = self::authorizationCredentialsFor($attributes['authorization'], AuthorizationScheme::BASIC);
