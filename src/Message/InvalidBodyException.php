...
final class InvalidBodyException extends \RuntimeException implements SourcedValidationExceptionInterface
{
    ...
    {
        $exception = new self('The request body is not valid.');
    ...
    {
        return ErrorCode::MALFORMED_CONTENT;
    }
    ...
    {
        return Source::forPointer($error);
    }
}
